...
public class Demo_finance {
    public static void main(String[] args) throws Exception {
        // 从本体与实例数据文件创建各自的文件对象
        File ontologyFile = new File(Demo_finance.class.getResource("/data/finance_onto.owl").toURI());
        File dataFile = new File(Demo_finance.class.getResource("/data/finance_data.nt").toURI());
        File ruleFile = new File(Demo_finance.class.getResource("/data/finance_rule.txt").toURI());
        // 创建数据存储
