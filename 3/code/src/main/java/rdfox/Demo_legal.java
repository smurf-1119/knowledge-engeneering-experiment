...
public class Demo_legal {
    public static void main(String[] args) throws Exception {
        // 从本体与实例数据文件创建各自的文件对象
//        File ontologyFile = new File(Demo_legal.class.getResource("/data/finance_onto.owl").toURI());
        File dataFile = new File(Demo_legal.class.getResource("/data/legal_data.nt").toURI());
        File ruleFile = new File(Demo_legal.class.getResource("/data/legal_rule.txt").toURI());
        // 创建数据存储
